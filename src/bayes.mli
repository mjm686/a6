...
(**
 * [prior_probability cat ps] returns the prior probability of any point being
 * a certain category cat. That is, it returns the number of points of that
 * category divided by the total number of points in ps.
 *
 * The proabilitiy is a float from 0.0 to 1.0 inclusive.
 *)
val prior_probability  : cat -> points -> float

(**
 * [likelihood p cat ps] returns the likelihood of having point p given category
 * cat.
 *
 * The proabilitiy is a float from 0.0 to 1.0 inclusive.
 *)
...
(**
 * [posterior_probability p cat ps] returns the posterior probability of
